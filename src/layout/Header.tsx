...
<div className="absolute left-1/2 transform -translate-x-1/2">
  <div className="flex items-center space-x-6 font-semibold text-sm text-gray-900 dark:text-white">
    ...
    <a href="/cohort" className="flex items-center gap-1 hover:text-purple-500 transition">
    ...
    {/* Udemy */}
    <a href="/udemy" className="flex items-center gap-1 hover:text-purple-500 transition">
      <FaGraduationCap />
      <span>Udemy</span>
    </a>

    {/* Docs */}
    <a href="/docs" className="flex items-center gap-1 hover:text-purple-500 transition">
      <FaFileAlt />
      <span>Docs</span>
    </a>

    {/* Reviews */}
    <a href="/reviews" className="flex items-center gap-1 hover:text-purple-500 transition">
      <FaStar />
      <span>Reviews</span>
    </a>
  </div>
