  ...
  return (
    <>
      ...
      >
          ...
          <motion.div variants={cardVariants}>
            <CardSpotlight className="h-40 w-full max-w-md bg-transparent shadow-xl hover:shadow-2xl transition-all duration-300 dark:border-2 border-0">
              <div className="flex flex-col w-full h-full px-6 py-4 bg-white/90 dark:bg-black/90 hover:bg-white dark:hover:bg-black transition-colors duration-300">
                <p className="text-xl font-bold relative z-20 flex items-center gap-2 mt-2 text-black dark:text-white">
                  <img
                    src={LogoDark}
                ...
                <p className="text-neutral-600 dark:text-neutral-300 mt-4 relative z-20 text-sm mb-3 p-2">
        ...
        >
          <div className="flex flex-col md:flex-row w-full h-full shadow-2xl overflow-hidden">
            {/* Left Section - Grid Logos */}
            <motion.div 
              className="md:w-1/3 w-full p-4 bg-white dark:bg-black flex justify-center items-center"
              variants={alumniVariants}
            >
              <div className="grid grid-cols-5 gap-3 w-full h-full justify-center items-center">
                {[
            ...
            >
              ...
              <p className="text-neutral-500 dark:text-neutral-300 mt-4 relative z-20 text-sm mb-3 p-2">
