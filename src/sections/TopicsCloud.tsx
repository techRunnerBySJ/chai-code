        ...
        >
          {[...items, ...items].map((item, idx) => (
            ...
            >
              ...
              />
<div 
  className="px-4 py-2 bg-white dark:bg-neutral-800 text-black dark:text-white rounded-[6px] relative group-hover:bg-transparent transition-all duration-300"
  role="presentation"
>
